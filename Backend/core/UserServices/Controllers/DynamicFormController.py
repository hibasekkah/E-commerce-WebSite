...
from core.Helpers import getDynamicFormModels, getDynamicFormFields, getExludeFields
...
class DynamicFormController(APIView):
    ...
    def post(self,request,modelName):
        ...
        for field in fields_info:
            if field.is_relation and field.name in fieldsdata and isinstance(fieldsdata[field.name],int):
                ...
                try:
                    ...
                    return Response(data=f'{field.name} Relation Not Exist found',message=f'{field.name} Relation Not Exist found',status=404)
        ...
        #         return Response(data='Model Item Not Found',message='Model Item Not Found',status=404)
