    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_order', models.PositiveIntegerField(blank=True, db_index=True, default=0, help_text="Ordre d'affichage des produits en vedette", null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('product', models.OneToOneField(blank=True, help_text='The single product this promotion applies to.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='promotion', to='Products.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_order', models.PositiveIntegerField(db_index=True, default=0, help_text='Controls the order of variations (e.g., 0 for Size, 1 for Color)')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.category')),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['start_date', 'end_date', 'is_active'], name='Products_pr_start_d_a8dcd5_idx'),
        ),
        migrations.AddIndex(
            model_name='promotion',
            index=models.Index(fields=['is_active', 'start_date'], name='Products_pr_is_acti_6d9227_idx'),
        ),
        migrations.AddIndex(
            model_name='promotion',
            index=models.Index(fields=['is_active', 'display_order'], name='Products_pr_is_acti_bb4ac0_idx'),
        ),
        migrations.AddIndex(
