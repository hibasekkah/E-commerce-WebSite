...
export default function CatProdPromotions({ catProds, delay, searchValue, searchType }) {
    

    let countProd = 0;
    const MoveToAddPromo = async (id) => {
        localStorage.setItem('productPromoId', id);
                        ...
                        (catProds.content.map((subCat) => {
                            ...
                            return(
                                ...
                                {   hasProd(subCat, 'subCategory') ?
                                                ...
                                                <tr key={prod.id} className='border-b-2 border-primary'>
                                                    ...
                                                    <td>
                                                         <div className='flex justify-end pr-3'>
                                                            <button 
                                                            className='my-2 px-4 py-2 rounded bg-gradient-to-tr from-red-500 to-red-700 text-white hover:from-red-700 hover:to-red-700'
                                                            onClick={() => {
                                                                MoveToAddPromo(prod.id)
                                                            }}>Set Discount</button>
                                                        </div> 
                                                    </td>
                                                </tr> : null
                                    ...
                                    :  <tr>
                                            <td colSpan={2} className='text-center py-3 text-primary font-semibold'>There are no products in this subcategory yet.</td>
                                        </tr>
                                }
